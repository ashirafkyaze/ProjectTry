...
export class UserProfileScreen extends Component {
  ...
  _following() {
    this.props.navigation.navigate('Following',this.user);
  }
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          <Body>
            <Title style={{ color: "#fff", fontSize: 20, textAlign: 'left' }}>My Profile</Title>
          </Body>
          <Right>
        ...
        <View style={styles1.containerStyle} >
          ...
          <View style={styles1.buttonWrapper}>
            <TouchableHighlight
              onPress={this._following.bind(this)}
            >
        ...
        >
          <Tab
            heading={<TabHeading style={{ backgroundColor: '#e8e8e8' }} tabStyle={{ color: 'red' }}><Text style={{ fontSize: 20 }}>Notifications</Text></TabHeading>} style={styles.tabStyle}
          >
            <View>
          ...
          <Tab
            ...
            heading={<TabHeading style={{ backgroundColor: '#e8e8e8' }}><Text style={{ fontSize: 20 }}>My Posts</Text></TabHeading>} style={styles.tabStyle}
          >

          </Tab>
          <Tab
            heading={<TabHeading style={{ backgroundColor: '#e8e8e8' }}><Text style={{ fontSize: 20 }}>Likes</Text></TabHeading>} style={styles.tabStyle}
          >
